 ...
 */
package com.mycompany.cst8218.leve0282.lab3restfulapi.service;

import com.mycompany.cst8218.leve0282.lab3restfulapi.Contact;
 ...
 */
@Stateless
@Path("com.mycompany.cst8218.leve0282.lab3restfulapi.contact")
public class ContactFacadeREST extends AbstractFacade<Contact> {
    ...
    public Response createPost(@Context UriInfo uriInfo, Contact entity) throws Exception {
        super.create(entity);
